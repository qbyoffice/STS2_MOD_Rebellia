...
public class BloodlustUrge() : RebelliaCard(1, CardType.Skill, CardRarity.Common, TargetType.Self)
{
    ...
    {
        int damageOnFail = (int)DynamicVars.HpLoss.BaseValue;
        int requiredAttacks = (int)DynamicVars.Cards.BaseValue;
        int costReductionBase = (int)DynamicVars.Energy.BaseValue;
        int layers = (int)DynamicVarsHelper.GetPowerVar<BloodlustUrgePower>(DynamicVars).BaseValue;
